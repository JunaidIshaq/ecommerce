...
//import com.shopfast.cartservice.service.ReviewService;
...
//
//    private final ReviewService cartService;
//
//    private final ProductClient productClient;
//
//    public OrderDataSeeder(OrderRepository orderRepository, ReviewService cartService, ProductClient productClient) {
...
//            }
//            productInternalResponse.setItems(orderItems.stream().map(OrderMapper::getOrderItemDto).toList());
//            cartService.placeOrder(productInternalResponse);
//        }
//
