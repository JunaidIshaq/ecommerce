//package com.shopfast.adminservice.events;
//
...
//
//
//    public KafkaPaymentConsumer(OrderRepository orderRepository, RedisProcessedEventStore processedEventStore, CartClient cartClient, KafkaOrderProducer kafkaOrderProducer, CouponAdminClient couponAdminClient) {
...
//                    try {
////                        couponAdminClient.redeem(new CouponRedeemRequestDto() {{
