...
import com.shopfast.adminservice.security.JwtAuthenticationFilter;
import com.shopfast.adminservice.security.JwtUtils;
...
//                        .requestMatchers("/api/v1/admin/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
                        ...
                        .requestMatchers("/api/v1/admin/actuator/**").permitAll()
